...
export function MobileHeader({ onLogout, items = [], groups }: MobileHeaderProps) {
  ...
  return (
    <div className="lg:hidden sticky top-0 z-40 bg-background/95 backdrop-blur-md border-b border-border/40 safe-area-top">
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="left" className="w-[80vw] max-w-xs p-0 safe-area-bottom" style={{ paddingTop: "max(env(safe-area-inset-top, 0px), 12px)" }}>
